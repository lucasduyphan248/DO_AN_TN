...
class ComputeOdometry(Node):
    ...
    def serial_callback(self, msg):
        ...
        try:
            ...
            self.v_robot = delta_x /dt
            self.v_theta = delta_theta /dt
            ...
            self.x_ = self.x_ +   delta_x* math.cos(self.theta_) 
            self.y_ =  self.y_  + delta_x* math.sin(self.theta_) 
    ...
    def publish_robot_state(self):
        ...
        odom_msg.twist.twist.linear.x = self.v_robot
